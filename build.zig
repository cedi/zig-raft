...
pub fn build(b: *std.Build) void {
    ...
    // Internal "log" module. Anything that lists it in `.imports` can do
    // `@import("log")`. Defined first so we can wire it into other modules below.
    ...
    const mod = b.addModule("zig_raft", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zig_raft" is the name you will use in your source code to
                // import this module (e.g. `@import("zig_raft")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "zig_raft", .module = mod },
                .{ .name = "log", .module = log_mod },
                .{ .name = "node", .module = node_mod },
            },
        }),
